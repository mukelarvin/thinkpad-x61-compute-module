...
// Keyboard LEDs
#define CAPS_LED 33   // includes 715 ohm resistor for 2ma LED 
...
int Row_IO[rows_max] = {9,11,24,26,41,40,14,25,13,10,12,8,6,4,7,5}; // Teensy LC I/O numbers for rows
//
...
int Col_IO[cols_max] = {17,21,19,18,20,16,22,23};  // Teensy LC I/O numbers for columns
//
